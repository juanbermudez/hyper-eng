...
- Hypercraft CLI extensions for multi-agent skill/plugin installs and primitive duplication.
- Codex plugin install tracking via `installed_plugins.json` parity.
