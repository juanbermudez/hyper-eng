...
**Output Location:** `$HYPER_WORKSPACE_ROOT/projects/{slug}/resources/framework-docs.md`
...
- Write directly to `$HYPER_WORKSPACE_ROOT/projects/{slug}/resources/framework-docs.md`
