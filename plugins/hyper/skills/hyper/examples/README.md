# Hypercraft VM Examples

These examples demonstrate workflows using Hypercraft VM's full feature set.
...
| `45-plugin-release.prose`         | Hypercraft VM plugin release workflow (this repo)          |
...
**Hypercraft VM advantages for RLMs:**
...
```
Run the code review example from the Hypercraft VM examples
```
