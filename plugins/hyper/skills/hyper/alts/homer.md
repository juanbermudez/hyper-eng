...
role: experimental
summary: |
  Homeric register for Hypercraft VM—an epic/heroic alternative keyword set.
  Heroes, trials, fates, and glory. For benchmarking against the functional register.
status: draft
requires: prose.md
---

# Hypercraft VM Homeric Register
...
An alternative register for Hypercraft VM that draws from Greek epic poetry—the Iliad, the Odyssey, and the heroic tradition. Programs become quests. Agents become heroes. Outputs become glory won.
