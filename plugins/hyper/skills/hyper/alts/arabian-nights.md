...
role: experimental
summary: |
  Arabian Nights register for Hypercraft VM—a narrative/nested alternative keyword set.
  Djinns, tales within tales, wishes, and oaths. For benchmarking against the functional register.
status: draft
requires: prose.md
---

# Hypercraft VM Arabian Nights Register
...
An alternative register for Hypercraft VM that draws from One Thousand and One Nights. Programs become tales told by Scheherazade. Recursion becomes stories within stories. Agents become djinns bound to serve.
