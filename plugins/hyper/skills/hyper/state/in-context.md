...
summary: |
  ...
  The Hypercraft VM "thinks aloud" to persist state—what you say becomes what you remember.
see-also:
...
This document describes how the Hypercraft VM tracks execution state using **structured narration** in the conversation history. This is one of two state management approaches (the other being file-based state in `filesystem.md`).
...
[Import] Importing: @alice/research
   Fetching from: https://p.hypercraft.dev/@alice/research
