...
summary: |
  File-system state management for Hypercraft VM programs. This approach persists
...
This document describes how the Hypercraft VM tracks execution state using **files in the `.prose/` directory**. This is one of two state management approaches (the other being in-context state in `in-context.md`).
